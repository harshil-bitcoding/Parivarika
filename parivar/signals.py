    ...
    if created:
        ...
        if existing_person:
            ...
            if person_serializer.is_valid():
                ...
                instance.save(update_fields=['top_member'])
            else:
                # If we cannot create a Person, don't proceed to translation
                return
 
        if instance.guj_name and 'person_instance' in locals() and person_instance:
